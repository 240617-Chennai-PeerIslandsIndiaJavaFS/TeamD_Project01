...
export let Milestones = [
    ...
    { milestone_id: 5, status: "Merged" },
    { milestone_id: 6, status: "Closed" },
    { milestone_id: 7, status: "In development" },
    { milestone_id: 8, status: "On hold" },
    { milestone_id: 9, status: "Pending" },
    { milestone_id: 10, status: "Completed" }
]
export let Projects = [
    {
        project_id: 1,
